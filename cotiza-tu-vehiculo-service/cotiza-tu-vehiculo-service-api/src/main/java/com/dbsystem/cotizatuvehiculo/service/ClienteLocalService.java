...
public interface ClienteLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ClienteLocalServiceUtil} to access the cliente local service. Add custom service methods to <code>com.dbsystem.cotizatuvehiculo.service.impl.ClienteLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
