...
/**
 * Provides the local service interface for ConcesionarioVehiculo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ConcesionarioVehiculoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ConcesionarioVehiculoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ConcesionarioVehiculoLocalServiceUtil} to access the concesionario vehiculo local service. Add custom service methods to <code>com.dbsystem.cotizatuvehiculo.service.impl.ConcesionarioVehiculoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
