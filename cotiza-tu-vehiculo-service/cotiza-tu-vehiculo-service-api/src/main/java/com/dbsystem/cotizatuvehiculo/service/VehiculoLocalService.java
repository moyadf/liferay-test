...
/**
 * Provides the local service interface for Vehiculo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see VehiculoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface VehiculoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VehiculoLocalServiceUtil} to access the vehiculo local service. Add custom service methods to <code>com.dbsystem.cotizatuvehiculo.service.impl.VehiculoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public Vehiculo createVehiculo(long vehiculoId);
	...
	public Vehiculo deleteVehiculo(long vehiculoId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Vehiculo fetchVehiculo(long vehiculoId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Vehiculo getVehiculo(long vehiculoId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Vehiculo> getVehiculos(int start, int end);
