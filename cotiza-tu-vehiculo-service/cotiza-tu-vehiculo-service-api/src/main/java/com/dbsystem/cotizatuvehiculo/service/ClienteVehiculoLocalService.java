...
/**
 * Provides the local service interface for ClienteVehiculo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ClienteVehiculoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ClienteVehiculoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ClienteVehiculoLocalServiceUtil} to access the cliente vehiculo local service. Add custom service methods to <code>com.dbsystem.cotizatuvehiculo.service.impl.ClienteVehiculoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
