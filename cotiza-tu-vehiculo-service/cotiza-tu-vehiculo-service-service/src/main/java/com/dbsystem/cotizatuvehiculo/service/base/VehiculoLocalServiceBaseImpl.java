...
import com.dbsystem.cotizatuvehiculo.service.VehiculoLocalService;
...
/**
 * Provides the base implementation for the vehiculo local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dbsystem.cotizatuvehiculo.service.impl.VehiculoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.dbsystem.cotizatuvehiculo.service.impl.VehiculoLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class VehiculoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements VehiculoLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>VehiculoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.dbsystem.cotizatuvehiculo.service.VehiculoLocalServiceUtil</code>.
	 */
	...
	public Vehiculo createVehiculo(long vehiculoId) {
		return vehiculoPersistence.create(vehiculoId);
	}
	...
	public Vehiculo deleteVehiculo(long vehiculoId) throws PortalException {
		return vehiculoPersistence.remove(vehiculoId);
	}
	...
	public Vehiculo deleteVehiculo(Vehiculo vehiculo) {
		return vehiculoPersistence.remove(vehiculo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Vehiculo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vehiculoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return vehiculoPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vehiculoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return vehiculoPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Vehiculo fetchVehiculo(long vehiculoId) {
		return vehiculoPersistence.fetchByPrimaryKey(vehiculoId);
	}
	...
	public Vehiculo getVehiculo(long vehiculoId) throws PortalException {
		return vehiculoPersistence.findByPrimaryKey(vehiculoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vehiculoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Vehiculo.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("vehiculoId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			vehiculoLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Vehiculo.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("vehiculoId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return vehiculoLocalService.deleteVehiculo((Vehiculo)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return vehiculoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Vehiculo> getVehiculos(int start, int end) {
		return vehiculoPersistence.findAll(start, end);
	}
	...
	public int getVehiculosCount() {
		return vehiculoPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			VehiculoLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		vehiculoLocalService = (VehiculoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return VehiculoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vehiculoPersistence.getDataSource();
	...
	protected VehiculoLocalService vehiculoLocalService;
